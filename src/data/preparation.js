export const preparationData = [
    {
        ...
        icon: 'search',
        color: 'indigo',
        titleKey: 'prep_awareness_title',
        bodyKey: 'prep_awareness_body',
        scriptureKey: 'prep_awareness_scripture',
        saintsKey: 'prep_awareness_saints',
    },
    {
        id: 'reconciliation',
        icon: 'handshake',
    ...
    },
    {
        ...
        color: 'emerald',
        titleKey: 'prep_confession_day_title',
        bodyKey: 'prep_confession_day_body',
        scriptureKey: 'prep_confession_day_scripture',
...
export const saintsQuotes = [
    {
        textKey: 'saints_quote_1',
        authorKey: 'saints_quote_1_author',
    },
    {
        textKey: 'saints_quote_2',
        authorKey: 'saints_quote_2_author',
    },
];
